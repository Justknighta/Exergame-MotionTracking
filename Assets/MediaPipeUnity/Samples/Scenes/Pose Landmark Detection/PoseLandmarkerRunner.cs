...
namespace Mediapipe.Unity.Sample.PoseLandmarkDetection
{
  public class PoseLandmarkerRunner : VisionTaskApiRunner<PoseLandmarker>
  {
    ...
    private void Awake()
    {
        config.MinPoseDetectionConfidence = 0.8f;
        config.MinPosePresenceConfidence = 0.8f;
        config.MinTrackingConfidence = 0.8f;

        config.NumPoses = 1; // สำคัญมาก กันแขนกระพริบ
    }


    public event Action<PoseLandmarkerResult> OnPoseResult;
